...
/*       .form
        .formHeader(APPEntitiesFormHeader(this.form).parameter("rootPath", myRootPath).parameter("mainTitle", "Attributes").parameter("subTitle", "Attributes anzeigen").actions([["print", "export"]]))
